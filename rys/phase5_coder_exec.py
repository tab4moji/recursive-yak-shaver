...
# -*- coding: utf-8 -*-
"""
Phase 5: Script Generation & Execution (v2.6)
Generates a complete bash script for a REQUEST based on the I/O plan in TOON format.
Resolves ref:TOPIC<N>.<binding> into variable references.
"""
...
def call_coder(topic, skill, host, port, model):
    ...
    # Resolve refs in input/output for the LLM prompt
