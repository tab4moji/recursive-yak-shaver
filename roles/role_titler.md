...
### Instructions
1. **Analyze** each Job block to understand its core purpose.
...
3. **Format** the Job block with your new Title.
   - Present the header with only the Job ID and your new Title, while omitting the original skill/status tags.
   - Preserve all `- Task:` lines exactly as they appear in the input.
   - Ensure the bullet points are maintained without any additions, removals, or modifications.

### Output Format
Job <N>: <Generated Title>
