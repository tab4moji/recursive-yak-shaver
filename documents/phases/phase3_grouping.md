...
- **LLM Role**: `grouper` (Role defined in `roles/role_grouper.md`)
...
2. The `grouper` role identifies if a task depends on the output of another task (e.g., "Find the price" before "Calculate the total").
